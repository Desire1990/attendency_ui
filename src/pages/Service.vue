<template>
  <div class="conge"><br><br><br><br>
            ...
            <section class="container-fluid">
                ...
                text-shadow: 1px 0px rgba(0,0,0,0.11)">TOUS LES SERVICES</h4>
                    <label class="btns">
                ...
                <tbody v-if = 'items.length==0'>
                  ...
                  <tr>
                    <center>
                      <h3>pas de services deja mise en place..</h3>                      
                    </center>
                  </tr>
                </tbody>                
                <tbody v-else>
...
import EditDialog from "../components/edit_service.vue";
import ServiceDialog from '../components/service_item'
export default{
